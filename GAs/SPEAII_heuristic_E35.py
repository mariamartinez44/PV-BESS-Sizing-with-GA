...
SPEA2 bi-objetivo para el dimensionamiento conjunto de un sistema
...
Objetivos del SPEA2 (bi-objetivo):
...
# ESPACIO DE BÚSQUEDA DEL SPEA2 — límites de los 13 genes
#
...
def evaluar_8760(x, data_8760, periodo_8760, T_8760):
    """
    Función de evaluación completa para un individuo del SPEA2.
...
class ProblemaSPEA2_E3E5(ElementwiseProblem):
    """
...
if __name__ == '__main__':
    ...
    # de lanzar el SPEA2. Los parámetros corresponden al sizing del MILP.
    diseno_ref = {
    ...
    problema = ProblemaSPEA2_E3E5(data_8760, periodo_8760, T_8760,
    ...
    algoritmo = SPEA2(
        pop_size=POP_SIZE,
        archive_size=POP_SIZE,        # tamaño del archivo externo (típicamente = pop_size)
    ...
    imprimir_resultado(idx_best_npv, 'SPEA2 E3+E5 v3 — Máx NPV',
                       pareto_X, real_res, real_m, real_capex_a, real_cf)
    imprimir_resultado(idx_best_bcr, 'SPEA2 E3+E5 v3 — Máx BCR',
                       pareto_X, real_res, real_m, real_capex_a, real_cf)
    ...
    guardar_csv_horario('solution_spea2_E3E5_hourly.csv',
                        d_best, real_res[idx_best_npv], real_m[idx_best_npv],
                        data_8760, T_8760, CF_best, npv_best)
    guardar_csv_resumen('solution_spea2_E3E5_summary.csv',
    ...
    with open('pareto_spea2_E3E5.csv', 'w', newline='') as f:
        w = csv.writer(f)
    ...
    print("CSV Pareto: pareto_spea2_E3E5.csv")

    # Gráficas de resultados
    fig, axes = plt.subplots(1, 2, figsize=(14, 5))
    fig.suptitle('SPEA2 E3+E5  |  OPEX vs CAPEX', fontsize=13, fontweight='bold')
    ...
    plt.tight_layout()
    plt.savefig('convergencia_spea2_E3E5.png', dpi=150)
    plt.show()
    print("Gráfica: convergencia_spea2_E3E5.png")